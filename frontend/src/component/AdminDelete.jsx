        ...
        <div className="flex flex-col md:flex-row justify-between items-start md:items-center mb-8 gap-4 bg-base-100 p-6 rounded-2xl shadow-sm border border-base-200">
          <div>
            ...
            <h1 className="text-3xl font-bold flex items-center gap-3">
              <Trash2 className="text-error" /> Delete Problems
            </h1>
            <p className="text-base-content/60 mt-1">Select a problem from the directory to permanently remove it.</p>
          </div>
                  ...
                  <tr key={problem._id} className="hover:bg-base-200/50 transition-colors">
                    ...
                    <td className="text-center">
                      <button
                        ...
                        className="btn btn-sm btn-error btn-outline gap-2 w-full hover:bg-error hover:text-white"
                      >
